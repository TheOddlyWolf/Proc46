class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 100, y: height - 1480, image: obstacle2Image },
      { x: width / 2 + 190, y: height - 1520, image: obstacle2Image },
      { x: width / 2 - 230, y: height - 2301, image: obstacle2Image },
  ...
  showFuelBar() {
    push();
    image(fuelImage, width / 2 - 130, height - player.positionY - 430, 20, 20);
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 430, 185, 20);
    fill("#ffc400");
    rect(width / 2 - 100, height - player.positionY - 430, player.fuel, 20);
    noStroke();
    pop();
  }
  //
